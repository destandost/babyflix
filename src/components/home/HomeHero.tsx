...
import { AgeBadge } from "@/components/home/AgeBadge";
import {
  getPlayerProfile,
  getStoredXp,
  xpIntoCurrentLevel,
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mb-2 flex flex-wrap items-center gap-2">
        <span className="inline-block rounded-full bg-white/20 px-3 py-1 font-display text-xs font-black uppercase tracking-wide text-white">

...
import { getLeaderboardWeekLabel } from "@/lib/leaderboard-npcs";
import {
  buildLeaderboard,
  getPlayerProfile,
  getStoredXp,
...
export function LeaderboardBoard() {
  ...
  return (
    <>
      ...
      >
        <h2 className="font-display mb-1 text-center text-xl text-white">🏆 Weekly Stars</h2>
        <p className="mb-4 text-center text-[11px] font-semibold text-white/80">
          This week · {getLeaderboardWeekLabel()}
        </p>
      ...
      <div className="mx-4 mb-4 rounded-3xl border border-brand-border bg-white p-4">
        <p className="font-display text-sm font-bold text-brand-text">Your name on the board</p>
      ...
      <p className="px-4 pb-6 text-center text-xs text-brand-muted">
        Rankings refresh each week. Play quizzes and games to earn XP and climb higher!
      </p>
    </>
  );
}

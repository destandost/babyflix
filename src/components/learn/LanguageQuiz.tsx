        ...
        {shuffled.map((opt) => (
          <li key={opt.id}>
            <button
              type="button"
              onClick={() => pick(opt.id)}
              className="flex w-full items-center justify-center rounded-[18px] border-[2.5px] border-[#E8E8F4] bg-white px-5 py-4 font-display text-lg text-brand-text transition-all hover:border-brand-purple hover:bg-brand-purple/5 active:scale-[0.97]"
            >
              {opt.label}
            </button>
          </li>
